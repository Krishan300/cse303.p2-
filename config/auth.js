...
module.exports = {
    'googleAuth' : {
        'clientID'      : '1098281097560-otnrtu86nln79mr5v40pc4ev9oqagrst.apps.googleusercontent.com', // TODO: put your client ID, from Google Developer Console
        'clientSecret'  : 'zoEs06ckmSPOIjFXzzAHI0vo', // TODO: put your client secret, from Google Developer Console
        'callbackURL'   : 'http://172.31.37.184:8080/auth/google/callback'  // TODO: you need to use your AWS IP and port, e.g., 'http://100.2.66.4:8080/auth/google/callback'
    },
